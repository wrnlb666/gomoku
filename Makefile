...
WFLAG = -Wall -Wextra -std=gnu17 -pedantic -s WASM=1 -s EXIT_RUNTIME=1 -s USE_SDL=2 -s USE_SDL_TTF=2 -s USE_SDL_NET=2 -s USE_SDL_IMAGE=2 -s SDL2_IMAGE_FORMATS='["png"]' --preload-file ./assets@/assets
